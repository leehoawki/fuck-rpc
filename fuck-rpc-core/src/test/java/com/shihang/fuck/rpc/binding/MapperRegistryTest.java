...
public class MapperRegistryTest {
    ...
    public void test1() {
        ...
        OrderInterface1 orderInterface1 = mapperRegistry.getMapper(OrderInterface1.class);
    ...
    public void test2() {
        MapperRegistry mapperRegistry = new MapperRegistry();
        OrderInterface2 orderInterface2 = mapperRegistry.getMapper(OrderInterface2.class);
        Order order = new Order();
        order.setIds(Arrays.asList(33665623));
        System.out.println(orderInterface2.select("sz", order));
    }
